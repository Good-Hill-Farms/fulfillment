...
def main():
    ...
    final_data = {"Oxnard": oxnard_structure, "Wheeling": wheeling_structure}
    ...
    print(
        f"  Total: {oxnard_simple + wheeling_simple} simple SKUs, {oxnard_bundles + wheeling_bundles} bundles"
    )
